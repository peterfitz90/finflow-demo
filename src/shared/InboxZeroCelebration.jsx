...
export function InboxZeroCelebration({ companyId, justCleared, theme = 'dark' }) {
  ...
  useEffect(() => {
    ...
    import('canvas-confetti').then(({ default: confetti }) => {
      confetti({
        ...
        spread: 58,
        origin: { y: 0.55 },
        colors: ['#10b981', '#34d399', '#059669', '#6366f1', '#f59e0b'],
        gravity: 1.1,
        scalar: 0.88,
        ticks: 220,
  ...
  const t = dark ? {
    ...
    streakBg:   'rgba(16,185,129,0.1)',
    streakBdr:  'rgba(16,185,129,0.25)',
    streakTxt:  '#10b981',
    check:      '#10b981',
    ...
    statLbl:    '#64748b',
    divider:    '#e2e8f0',
    streakBg:   'rgba(5,150,105,0.07)',
    streakBdr:  'rgba(5,150,105,0.22)',
    streakTxt:  '#059669',
    check:      '#059669',
    font:       "Inter, system-ui, sans-serif",
    monoFont:   "'Source Code Pro', monospace",
